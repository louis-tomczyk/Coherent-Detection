    ...
    for k = 1:nargin
        ...
        if size(varargin{k},2) == 1
            ...
            if size(E,2) == 1
                ...
                scatter(Ix,Qx,10,'filled','MarkerEdgeColor','y','MarkerFaceColor','y')
            ...
            for j = 1:N
                ...
                I = real(E);
                Q = imag(E);
                scatter(I,Q,10,'filled','MarkerEdgeColor',colors(j),'MarkerFaceColor',colors(j))
...
%     exportgraphics(fig,'tmp.png',"Resolution",50)
end